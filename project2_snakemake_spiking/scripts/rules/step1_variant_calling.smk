...
rule call_variants:
    ...
    output:
        ...
        variants = f"{results}/{{sample}}/{{variant}}/{{sample}}_raw_variants.vcf",
        snp = f"{results}/{{sample}}/{{variant}}/{{sample}}_raw_snps.vcf",
        indel = f"{results}/{{sample}}/{{variant}}/{{sample}}_raw_indels.vcf"
